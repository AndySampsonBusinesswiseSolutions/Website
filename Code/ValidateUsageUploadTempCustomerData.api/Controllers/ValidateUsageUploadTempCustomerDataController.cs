...
namespace ValidateUsageUploadTempCustomerData.api.Controllers
{
    ...
    public class ValidateUsageUploadTempCustomerDataController : ControllerBase
    {
        ...
        {
            //Launch API process
            _systemMethods.PostAsJsonAsync(validateUsageUploadTempCustomerDataAPIId, JObject.Parse(data.ToString()));
        ...
        public void Validate([FromBody] object data)
        {
            ...
            try
            {
                ...
                if(!_systemMethods.PrerequisiteAPIsAreSuccessful(_systemAPIGUIDEnums.ValidateUsageUploadTempCustomerDataAPI, validateUsageUploadTempCustomerDataAPIId, jsonObject))
                {
                    return;
                }
