...
namespace ValidateUsageUploadTempFlexContractData.api.Controllers
{
    ...
    public class ValidateUsageUploadTempFlexContractDataController : ControllerBase
    {
        ...
        {
            //Launch API process
            _systemMethods.PostAsJsonAsync(validateUsageUploadTempFlexContractDataAPIId, JObject.Parse(data.ToString()));
        ...
        public void Validate([FromBody] object data)
        {
            ...
            try
            {
                ...
                if(!_systemMethods.PrerequisiteAPIsAreSuccessful(_systemAPIGUIDEnums.ValidateUsageUploadTempFlexContractDataAPI, validateUsageUploadTempFlexContractDataAPIId, jsonObject))
                {
                    return;
                }
