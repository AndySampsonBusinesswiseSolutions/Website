...
namespace CommitMeterUsageDataApp
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                var commitMeterUsageDataAPIId = new Methods.SystemSchema.API().API_GetAPIIdByAPIGUID(new Enums.SystemSchema.API.GUID().CommitMeterUsageDataAPI);
