...
namespace CommitEstimatedAnnualUsageApp
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                var commitEstimatedAnnualUsageAPIId = new Methods.SystemSchema.API().API_GetAPIIdByAPIGUID(new Enums.SystemSchema.API.GUID().CommitEstimatedAnnualUsageAPI);
