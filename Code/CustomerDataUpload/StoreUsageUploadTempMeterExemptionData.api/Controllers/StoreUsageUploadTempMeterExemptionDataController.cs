...
namespace StoreUsageUploadTempMeterExemptionData.api.Controllers
{
    ...
    public class StoreUsageUploadTempMeterExemptionDataController : ControllerBase
    {
        ...
        {
            //Launch API process
            _systemMethods.PostAsJsonAsync(storeUsageUploadTempMeterExemptionDataAPIId, JObject.Parse(data.ToString()));
        ...
        public void Store([FromBody] object data)
        {
            ...
            try
            {
                ...
                if(!_systemMethods.PrerequisiteAPIsAreSuccessful(_systemAPIGUIDEnums.StoreUsageUploadTempMeterExemptionDataAPI, storeUsageUploadTempMeterExemptionDataAPIId, jsonObject))
                {
                    return;
                }
