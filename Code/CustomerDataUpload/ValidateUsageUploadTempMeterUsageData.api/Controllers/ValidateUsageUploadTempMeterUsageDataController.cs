...
namespace ValidateUsageUploadTempMeterUsageData.api.Controllers
{
    ...
    public class ValidateUsageUploadTempMeterUsageDataController : ControllerBase
    {
        ...
        {
            //Launch API process
            _systemMethods.PostAsJsonAsync(validateUsageUploadTempMeterUsageDataAPIId, JObject.Parse(data.ToString()));
        ...
        public void Validate([FromBody] object data)
        {
            ...
            try
            {
                ...
                if(!_systemMethods.PrerequisiteAPIsAreSuccessful(_systemAPIGUIDEnums.ValidateUsageUploadTempMeterUsageDataAPI, validateUsageUploadTempMeterUsageDataAPIId, jsonObject))
                {
                    return;
                }
