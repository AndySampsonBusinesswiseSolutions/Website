...
namespace ValidateFixedContractDataApp
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                var validateFixedContractDataAPIId = new Methods.SystemSchema.API().API_GetAPIIdByAPIGUID(new Enums.SystemSchema.API.GUID().ValidateFixedContractDataAPI);
