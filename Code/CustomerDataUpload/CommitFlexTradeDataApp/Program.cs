...
namespace CommitFlexTradeDataApp
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                var commitFlexTradeDataAPIId = new Methods.SystemSchema.API().API_GetAPIIdByAPIGUID(new Enums.SystemSchema.API.GUID().CommitFlexTradeDataAPI);
