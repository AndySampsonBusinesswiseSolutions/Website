...
namespace ValidateFlexTradeDataApp
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                var validateFlexTradeDataAPIId = new Methods.SystemSchema.API().API_GetAPIIdByAPIGUID(new Enums.SystemSchema.API.GUID().ValidateFlexTradeDataAPI);
