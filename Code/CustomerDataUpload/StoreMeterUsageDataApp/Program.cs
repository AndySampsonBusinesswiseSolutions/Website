...
namespace StoreMeterUsageDataApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                var storeMeterUsageDataAPIId = new Methods.SystemSchema.API().API_GetAPIIdByAPIGUID(new Enums.SystemSchema.API.GUID().StoreMeterUsageDataAPI);
