...
namespace ValidateFlexContractDataApp
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                var validateFlexContractDataAPIId = new Methods.SystemSchema.API().API_GetAPIIdByAPIGUID(new Enums.SystemSchema.API.GUID().ValidateFlexContractDataAPI);
                ...
                if(!new Methods.SystemSchema.API().PrerequisiteAPIsAreSuccessful(new Enums.SystemSchema.API.GUID().ValidateFlexContractDataAPI, validateFlexContractDataAPIId, hostEnvironment, jsonObject))
                {
                    return;
                }
                ...
                var flexContractEntities = new Methods.TempSchema.CustomerDataUpload.FlexContract().FlexContract_GetByProcessQueueGUID(processQueueGUID);
