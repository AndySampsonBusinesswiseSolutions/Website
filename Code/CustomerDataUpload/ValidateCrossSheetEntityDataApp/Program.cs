...
namespace ValidateCrossSheetEntityDataApp
{
    class Program
    {
        private static readonly Methods.TempSchema.CustomerDataUpload _tempCustomerDataUploadMethods = new Methods.TempSchema.CustomerDataUpload();
        private static Int64 validateCrossSheetEntityDataAPIId;
        private static Int64 createdByUserId;
        private static Int64 sourceId;
        ...
        private static string ValidateCrossEntities(List<DataRow> mainDataRows, List<DataRow> crossEntityDataRows, long attributeId, string columnName, string columnDisplayName, string sheetName, string otherSheetName)
        {
        ...
        private static long GetDetailId(long attributeId, string detailDescription, string sheetName)
        {
