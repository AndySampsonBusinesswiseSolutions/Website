...
namespace ValidateUsageUploadTempFixedContractData.api.Controllers
{
    ...
    public class ValidateUsageUploadTempFixedContractDataController : ControllerBase
    {
        ...
        {
            //Launch API process
            _systemMethods.PostAsJsonAsync(validateUsageUploadTempFixedContractDataAPIId, JObject.Parse(data.ToString()));
        ...
        public void Validate([FromBody] object data)
        {
            ...
            try
            {
                ...
                if(!_systemMethods.PrerequisiteAPIsAreSuccessful(_systemAPIGUIDEnums.ValidateUsageUploadTempFixedContractDataAPI, validateUsageUploadTempFixedContractDataAPIId, jsonObject))
                {
                    return;
                }
