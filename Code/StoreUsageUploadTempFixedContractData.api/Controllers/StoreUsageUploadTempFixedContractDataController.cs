...
namespace StoreUsageUploadTempFixedContractData.api.Controllers
{
    ...
    public class StoreUsageUploadTempFixedContractDataController : ControllerBase
    {
        ...
        public bool IsRunning([FromBody] object data)
        {
            ...
            //Launch API process
            _systemMethods.PostAsJsonAsync(storeUsageUploadTempFixedContractDataAPIId, callingGUID, jsonObject);
        ...
        public void Store([FromBody] object data)
        {
            ...
            try
            {
                ...
                var API = _systemMethods.PostAsJsonAsync(checkPrerequisiteAPIAPIId, _systemAPIGUIDEnums.StoreUsageUploadTempFixedContractDataAPI, jsonObject);
                ...
                if(erroredPrerequisiteAPIs.Any())
                {
                    ...
                    _systemMethods.ProcessQueue_Update(processQueueGUID, storeUsageUploadTempFixedContractDataAPIId, true, $" Prerequisite APIs {string.Join(",", erroredPrerequisiteAPIs)} errored");
                    return;
                }
