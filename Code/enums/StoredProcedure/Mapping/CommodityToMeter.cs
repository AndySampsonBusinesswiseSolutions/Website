    ...
    public partial class Enums
    {
        public partial class StoredProcedure
        {
            public partial class Mapping
            {
                ...
                public string CommodityToMeter_GetByCommodityId = "[Mapping].[CommodityToMeter_GetByCommodityId]";
                public string CommodityToMeter_GetByCommodityIdAndMeterId = "[Mapping].[CommodityToMeter_GetByCommodityIdAndMeterId]";
            }
        }
    }
}