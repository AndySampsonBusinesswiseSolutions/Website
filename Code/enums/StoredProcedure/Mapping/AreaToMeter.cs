    ...
    public partial class Enums
    {
        public partial class StoredProcedure
        {
            public partial class Mapping
            {
                ...
                public string AreaToMeter_GetByAreaIdAndMeterId = "[Mapping].[AreaToMeter_GetByAreaIdAndMeterId]";
                public string AreaToMeter_DeleteByMeterId = "[Mapping].[AreaToMeter_DeleteByMeterId]";
            }
        }
    }
}