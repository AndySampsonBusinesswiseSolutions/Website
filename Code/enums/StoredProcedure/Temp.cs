    ...
    public partial class Enums
    {
        public partial class StoredProcedure
        {
            public class Temp
            {
                ...
                {
                    public string Site_Insert = "[Temp.CustomerDataUpload].[Site_Insert]";
                    public string Meter_Insert = "[Temp.CustomerDataUpload].[Meter_Insert]";
                    public string MeterUsage_Insert = "[Temp.CustomerDataUpload].[MeterUsage_Insert]";
                    public string SubMeter_Insert = "[Temp.CustomerDataUpload].[SubMeter_Insert]";
                    public string SubMeterUsage_Insert = "[Temp.CustomerDataUpload].[SubMeterUsage_Insert]";
                    ...
                    public string SubMeter_GetByProcessQueueGUID = "[Temp.CustomerDataUpload].[SubMeter_GetByProcessQueueGUID]";
                    public string SubMeterUsage_GetByProcessQueueGUID = "[Temp.CustomerDataUpload].[SubMeterUsage_GetByProcessQueueGUID]";
