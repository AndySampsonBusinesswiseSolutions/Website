...
namespace CreateDataAnalysisWebpageApp
{
    class Program
    {
        ...
        private static Dictionary<string, long> attributeDictionary = new Dictionary<string, long>();
        private static Dictionary<long, long> meterCommodityDictionary = new Dictionary<long, long>();
        private static Dictionary<long, string> commodityDictionary = new Dictionary<long, string>();
        private static Dictionary<long, string> areaDictionary = new Dictionary<long, string>();
        private static Dictionary<long, string> subAreaDictionary = new Dictionary<long, string>();
        private static Dictionary<long, string> assetGUIDDictionary = new Dictionary<long, string>();
        private static Dictionary<long, string> assetNameDictionary = new Dictionary<long, string>();
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                var createDataAnalysisWebpageAPIId = new Methods.SystemSchema.API().API_GetAPIIdByAPIGUID(new Enums.SystemSchema.API.GUID().CreateDataAnalysisWebpageAPI);
        ...
        private static void BuildSiteBranch(List<long> siteIds)
        {
        ...
        private static string BuildAreaBranch(Dictionary<long, List<long>> areaMeterDictionary, long siteId)
        {
        ...
        private static string BuildCommodityBranch(List<long> meterIds, long siteId, long areaId)
        {
        ...
        private static string BuildMeterBranch(long siteId, long areaId, long commodityId, List<long> meterIds)
        {
        ...
        private static string BuildSubAreaBranch(Dictionary<long, List<long>> subAreaSubMeterDictionary, long siteId, long areaId, long commodityId, long meterId)
        {
        ...
        private static string BuildAssetBranch(List<long> subMeterIds)
        {
        ...
        private static string BuildSubMeterBranch(List<long> subMeterIds)
        {
        ...
        private static Dictionary<long, List<long>> BuildAreaMeterDictionary(List<long> meterIds)
        {
        ...
        private static Dictionary<long, List<long>> BuildSubAreaSubMeterDictionary(List<long> subMeterIds)
        {
        ...
        private static bool CommodityMeterMatch(long meterId)
        {
            return CommodityMeterMatch(new List<long>{meterId});
        }

        private static bool CommodityMeterMatch(List<long> meterIds)
        {
            //Get commodities linked to meters
            var commodityIds = meterIds.Select(m => meterCommodityDictionary[m]).Distinct().ToList();
        ...
        private static string GetLiHtml(string type, string guid, string value, string ulHTML)
        {
