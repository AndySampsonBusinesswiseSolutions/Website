            ...
            public partial class API
            {
                public bool PrerequisiteAPIsAreSuccessful(string APIGUID, long APIId, string hostEnvironmentName, JObject jsonObject)
                {
                    ...
                    if(erroredPrerequisiteAPIs.Any())
                    {
                        ...
                        systemMethods.ProcessQueue_UpdateEffectiveFromDateTime(processQueueGUID, APIId);
                        systemMethods.ProcessQueue_UpdateEffectiveToDateTime(processQueueGUID, APIId, true, $" Prerequisite APIs {string.Join(",", erroredPrerequisiteAPIs)} errored");
                    }
                ...
                private HttpClient CreateAPI(long APIId, string hostEnvironmentName)
                {
                ...
                private string GetAPIURLByAPIId(long APIId, string hostEnvironmentName) 
                {
                ...
                private string GetAPIIsRunningRouteByAPIId(long APIId) 
                {
                ...
                private string GetAPIPOSTRouteByAPIId(long APIId) 
                {
                ...
                private string GetAPIStartupURLs(string hostEnvironmentName, string APIGUID)
                {
                ...
                private Dictionary<long, string> APIDetail_GetAPIDetailIdDescriptionDictionaryByAPIIdAndAPIAttributeId(long APIId, long APIAttributeId)
                {
                    var dataTable = GetDataTable(MethodBase.GetCurrentMethod().GetParameters(), 
                        _storedProcedureSystemEnums.APIDetail_GetByAPIIdAndAPIAttributeId, 
                        APIId, APIAttributeId);
                ...
                private void ConfigureAPIStartupServices(IServiceCollection services, string hostEnvironmentName)
                {
