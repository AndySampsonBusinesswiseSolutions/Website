...
namespace ValidateUsageUploadTempFlexReferenceVolumeData.api
{
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .ConfigureWebHostDefaults(webBuilder =>
                {
                    ...
                    webBuilder.UseUrls(_systemMethods.GetAPIStartupURLs(_systemAPIGUIDEnums.ValidateUsageUploadTempFlexReferenceVolumeDataAPI));
                });
    }
}
