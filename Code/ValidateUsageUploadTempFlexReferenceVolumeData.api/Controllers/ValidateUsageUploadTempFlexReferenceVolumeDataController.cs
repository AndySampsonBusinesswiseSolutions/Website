...
namespace ValidateUsageUploadTempFlexReferenceVolumeData.api.Controllers
{
    ...
    public class ValidateUsageUploadTempFlexReferenceVolumeDataController : ControllerBase
    {
        ...
        public bool IsRunning([FromBody] object data)
        {
            ...
            //Launch API process
            _systemMethods.PostAsJsonAsync(validateUsageUploadTempFlexReferenceVolumeDataAPIId, callingGUID, jsonObject);
        ...
        public void Validate([FromBody] object data)
        {
            ...
            try
            {
                ...
                var API = _systemMethods.PostAsJsonAsync(checkPrerequisiteAPIAPIId, _systemAPIGUIDEnums.ValidateUsageUploadTempFlexReferenceVolumeDataAPI, jsonObject);
                ...
                if(erroredPrerequisiteAPIs.Any())
                {
                    ...
                    _systemMethods.ProcessQueue_Update(processQueueGUID, validateUsageUploadTempFlexReferenceVolumeDataAPIId, true, $" Prerequisite APIs {string.Join(",", erroredPrerequisiteAPIs)} errored");
                    return;
                }
