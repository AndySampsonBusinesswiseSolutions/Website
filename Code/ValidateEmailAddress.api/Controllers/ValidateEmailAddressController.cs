    ...
    public class ValidateEmailAddressController : ControllerBase
    {
        ...
        public void Validate([FromBody] object data)
        {
            ...
            if(!erroredPrerequisiteAPIs.Any())
            {
                ...
                var emailAddressId = _administrationMethods.UserDetailId_GetByEmailAddress(_databaseInteraction, emailAddress);
                ...
                _systemMethods.ProcessQueue_Update(_databaseInteraction, queueGUID, _systemAPIGUIDEnums.ValidateEmailAddressAPI, emailAddressId == 0);
            }
            else
            {
                //Update Process Queue
                _systemMethods.ProcessQueue_Update(_databaseInteraction, queueGUID, _systemAPIGUIDEnums.ValidateEmailAddressAPI, true);
            }
        }
    }
}
