    ...
    public partial class Temp
    {
        public partial class CustomerDataUpload
        {
            public class FixedContract
            {
                ...
                public FixedContract(Guid ProcessQueueGUID_,int RowId_,string ContractReference_,string MPXN_,string Supplier_,string ContractStartDate_,string ContractEndDate_,string Product_,string RateCount_,string RateType_,string Value_,bool CanCommit_)
                {
                    ...
                    this.RateCount = RateCount_;
                    this.RateType = RateType_;
                    this.Value = Value_;
                    this.CanCommit = CanCommit_;
                }

                public FixedContract(DataRow dataRow)
                {
                    ...
                    this.RateCount = (string)dataRow["RateCount"];
