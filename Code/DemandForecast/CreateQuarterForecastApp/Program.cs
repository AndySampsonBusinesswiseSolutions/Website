...
namespace CreateQuarterForecastApp
{
    class Program
    {
        private static string granularityCode = "Quarter";
        private static List<Tuple<long, long, decimal>> existingQuarterForecasts;
        private static Dictionary<long, Dictionary<long, decimal>> existingQuarterForecastDictionary;
        private static Dictionary<long, decimal> forecastDictionary;
        private static List<long> forecastYearIds;
        private static Dictionary<long, List<long>> quarterToDateDictionary;
