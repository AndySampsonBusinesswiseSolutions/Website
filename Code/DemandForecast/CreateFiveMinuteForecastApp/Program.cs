    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                var createFiveMinuteForecastAPIId = new Methods.SystemSchema.API().API_GetAPIIdByAPIGUID(new Enums.SystemSchema.API.GUID().CreateFiveMinuteForecastAPI);
                ...
                if (newFiveMinuteForecastTuples.Any())
                {
                    ...
                    new Methods.SupplySchema().CreateGranularSupplyForecastDataTables(meterType, meterId, granularityCode, createdByUserId, sourceId, new List<string> { "DateId", "TimePeriodId" }, newFiveMinuteForecastTuples.ToList(), existingFiveMinuteForecasts);
                }
        ...
        private static void GetExistingForecast(string meterType, long meterId)
        {
            ...
            existingFiveMinuteForecasts = new Methods.SupplySchema().ForecastUsageGranularityLatest_GetLatestTuple(meterType, meterId, granularityCode, "DateId", "TimePeriodId");
