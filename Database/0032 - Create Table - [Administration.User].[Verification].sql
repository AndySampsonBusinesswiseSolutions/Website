...
GO
ALTER TABLE [Administration.User].[Verification] ADD CONSTRAINT
	DF_Verification_EffectiveFromDateTime DEFAULT GETDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [Administration.User].[Verification] ADD CONSTRAINT
	DF_Verification_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [Administration.User].[Verification] ADD CONSTRAINT
	DF_Verification_CreatedDateTime DEFAULT GETDATE() FOR CreatedDateTime
GO
ALTER TABLE [Administration.User].[Verification] ADD CONSTRAINT
	DF_Verification_ExpiryDateTime DEFAULT DATEADD(HOUR, 1, GETDATE()) FOR ExpiryDateTime
GO
ALTER TABLE [Administration.User].[Verification] ADD CONSTRAINT
