...
GO
ALTER TABLE [System].[ProcessArchiveAttribute] ADD CONSTRAINT
	DF_ProcessArchiveAttribute_EffectiveFromDateTime DEFAULT GETUTCDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [System].[ProcessArchiveAttribute] ADD CONSTRAINT
	DF_ProcessArchiveAttribute_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [System].[ProcessArchiveAttribute] ADD CONSTRAINT
	DF_ProcessArchiveAttribute_CreatedDateTime DEFAULT GETUTCDATE() FOR CreatedDateTime
GO
ALTER TABLE [System].[ProcessArchiveAttribute] ADD CONSTRAINT
