...
GO
ALTER TABLE [System].[Process] ADD CONSTRAINT
	DF_Process_EffectiveFromDateTime DEFAULT GETUTCDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [System].[Process] ADD CONSTRAINT
	DF_Process_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [System].[Process] ADD CONSTRAINT
	DF_Process_CreatedDateTime DEFAULT GETUTCDATE() FOR CreatedDateTime
GO
ALTER TABLE [System].[Process] ADD CONSTRAINT
...
GO
ALTER TABLE [System].[Process] ADD CONSTRAINT
	FK_Process_SourceId FOREIGN KEY
	(
	SourceId
...
GO
DECLARE @v sql_variant 
SET @v = N'Foreign Key constraint joining [System].[Process].SourceId to [Information].[Source].SourceId'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'System', N'TABLE', N'Process', N'CONSTRAINT', N'FK_Process_SourceId'
GO
