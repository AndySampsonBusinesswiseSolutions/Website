...
GO
ALTER TABLE [System].[ProcessArchiveDetail] ADD CONSTRAINT
	DF_ProcessArchiveDetail_EffectiveFromDateTime DEFAULT GETUTCDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [System].[ProcessArchiveDetail] ADD CONSTRAINT
	DF_ProcessArchiveDetail_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [System].[ProcessArchiveDetail] ADD CONSTRAINT
	DF_ProcessArchiveDetail_CreatedDateTime DEFAULT GETUTCDATE() FOR CreatedDateTime
GO
ALTER TABLE [System].[ProcessArchiveDetail] ADD CONSTRAINT
