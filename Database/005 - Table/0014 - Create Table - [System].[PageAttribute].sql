...
GO
ALTER TABLE [System].[PageAttribute] ADD CONSTRAINT
	DF_PageAttribute_EffectiveFromDateTime DEFAULT GETUTCDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [System].[PageAttribute] ADD CONSTRAINT
	DF_PageAttribute_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [System].[PageAttribute] ADD CONSTRAINT
	DF_PageAttribute_CreatedDateTime DEFAULT GETUTCDATE() FOR CreatedDateTime
GO
ALTER TABLE [System].[PageAttribute] ADD CONSTRAINT
