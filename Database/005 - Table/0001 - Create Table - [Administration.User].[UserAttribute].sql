...
GO
ALTER TABLE [Administration.User].[UserAttribute] ADD CONSTRAINT
	DF_UserAttribute_EffectiveFromDateTime DEFAULT GETUTCDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [Administration.User].[UserAttribute] ADD CONSTRAINT
	DF_UserAttribute_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [Administration.User].[UserAttribute] ADD CONSTRAINT
	DF_UserAttribute_CreatedDateTime DEFAULT GETUTCDATE() FOR CreatedDateTime
GO
ALTER TABLE [Administration.User].[UserAttribute] ADD CONSTRAINT
