...
GO
DECLARE @v sql_variant 
SET @v = N'Foreign Key constraint joining [Mapping].[ProductToSupplier].SupplierId to [Information].[Supplier].SupplierId'
...
GO
DECLARE @v sql_variant 
SET @v = N'Foreign Key constraint joining [Mapping].[ProductToSupplier].ProductId to [Product].[Product].ProductId'
