...
GO
ALTER TABLE [Communication].[Communication] ADD CONSTRAINT
	DF_Communication_EffectiveFromDateTime DEFAULT GETUTCDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [Communication].[Communication] ADD CONSTRAINT
	DF_Communication_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [Communication].[Communication] ADD CONSTRAINT
	DF_Communication_CreatedDateTime DEFAULT GETUTCDATE() FOR CreatedDateTime
GO
ALTER TABLE [Communication].[Communication] ADD CONSTRAINT
