...
GO
ALTER TABLE [System].[ProcessArchive] ADD CONSTRAINT
	DF_ProcessArchive_EffectiveFromDateTime DEFAULT GETDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [System].[ProcessArchive] ADD CONSTRAINT
	DF_ProcessArchive_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [System].[ProcessArchive] ADD CONSTRAINT
	DF_ProcessArchive_CreatedDateTime DEFAULT GETDATE() FOR CreatedDateTime
GO
ALTER TABLE [System].[ProcessArchive] ADD CONSTRAINT
