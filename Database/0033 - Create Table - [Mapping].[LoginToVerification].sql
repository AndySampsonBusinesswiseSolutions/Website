...
GO
ALTER TABLE [Mapping].[LoginToVerification] ADD CONSTRAINT
	DF_LoginToVerification_EffectiveFromDateTime DEFAULT GETDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [Mapping].[LoginToVerification] ADD CONSTRAINT
	DF_LoginToVerification_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [Mapping].[LoginToVerification] ADD CONSTRAINT
	DF_LoginToVerification_CreatedDateTime DEFAULT GETDATE() FOR CreatedDateTime
GO
ALTER TABLE [Mapping].[LoginToVerification] ADD CONSTRAINT
