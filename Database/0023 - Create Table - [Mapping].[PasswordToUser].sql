...
GO
ALTER TABLE [Mapping].[PasswordToUser] ADD CONSTRAINT
	DF_PasswordToUser_EffectiveFromDateTime DEFAULT GETDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [Mapping].[PasswordToUser] ADD CONSTRAINT
	DF_PasswordToUser_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [Mapping].[PasswordToUser] ADD CONSTRAINT
	DF_PasswordToUser_CreatedDateTime DEFAULT GETDATE() FOR CreatedDateTime
GO
ALTER TABLE [Mapping].[PasswordToUser] ADD CONSTRAINT
