...
DECLARE @SQL NVARCHAR(MAX) = N'
    ...
    -- Description:	Get latest usage from [Supply.X].[ForecastUsageFiveMinuteHistory] table
    -- =============================================
    ...
    BEGIN
        ...
        (
            SELECT
                DateId,
                TimePeriodId,
                MAX(ForecastUsageFiveMinuteHistoryId) AS ForecastUsageFiveMinuteHistoryId
            FROM
        ...
        SELECT
            ForecastUsageFiveMinuteHistory.ForecastUsageFiveMinuteHistoryId,
            ForecastUsageFiveMinuteHistory.CreatedDateTime,
            ForecastUsageFiveMinuteHistory.CreatedByUserId,
            ForecastUsageFiveMinuteHistory.SourceId,
            ForecastUsageFiveMinuteHistory.DateId,
            ForecastUsageFiveMinuteHistory.TimePeriodId,
            ForecastUsageFiveMinuteHistory.Usage
        FROM
            [Supply.X].[ForecastUsageFiveMinuteHistory]
        INNER JOIN
            Latest
            ON Latest.ForecastUsageFiveMinuteHistoryId = ForecastUsageFiveMinuteHistory.ForecastUsageFiveMinuteHistoryId
    END'
...
SET @SQL = N'
    ...
    -- Author:		System Generated
    -- Create date: 2020-09-28
    -- Description:	Get latest usage from [Supply.X].[ForecastUsageFiveMinuteLatest] table
    -- =============================================
