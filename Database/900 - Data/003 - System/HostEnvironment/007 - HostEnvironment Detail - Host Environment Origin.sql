...
DECLARE @HostEnvironmentAttributeId BIGINT = (SELECT HostEnvironmentAttributeId FROM [System].[HostEnvironmentAttribute] WHERE HostEnvironmentAttributeDescription = 'Host Environment Origin')
...
EXEC [System].[HostEnvironmentDetail_Insert] @CreatedByUserId, @SourceId, @HostEnvironmentId, @HostEnvironmentAttributeId, 'http://energyportal:8080'
