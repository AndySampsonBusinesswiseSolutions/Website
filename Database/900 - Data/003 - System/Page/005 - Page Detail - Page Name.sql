...
DECLARE @PageId BIGINT = (SELECT PageId FROM [System].[Page] WHERE PageGUID = '6641A1BF-84C8-48F8-9D79-70D0AB2BB787') --Login
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'Login'

SET @PageId  = (SELECT PageId FROM [System].[Page] WHERE PageGUID = '342B0397-8DBD-4782-9A96-6C714450264A') --Dashboard
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'Dashboard'

SET @PageId  = (SELECT PageId FROM [System].[Page] WHERE PageGUID = 'A78E3EB1-C69E-4DFE-9653-C30ADDD4D3BF') --Data Analysis
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'Data Analysis'

SET @PageId  = (SELECT PageId FROM [System].[Page] WHERE PageGUID = 'D250779D-2A3C-44A4-B343-9F5C920CED3A') --Budget Management
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'Budget Management'

SET @PageId  = (SELECT PageId FROM [System].[Page] WHERE PageGUID = '0FAF0BF4-FE77-4A9D-8FDB-CA81CE2905CC') --Invoice Management
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'Invoice Management'

SET @PageId  = (SELECT PageId FROM [System].[Page] WHERE PageGUID = '74268A15-79AB-4375-930F-028C99297F38') --Revenue Management
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'Revenue Management'

SET @PageId  = (SELECT PageId FROM [System].[Page] WHERE PageGUID = 'B228030E-F3FE-46BF-94DF-2C6C8B1D71F3') --Opportunities Dashboard
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'Opportunities Dashboard'
...
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'Supplier Product Management'

SET @PageId  = (SELECT PageId FROM [System].[Page] WHERE PageGUID = '6B23BB38-0850-4969-B786-B7751EC04442') --My Profile
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'My Profile'

SET @PageId  = (SELECT PageId FROM [System].[Page] WHERE PageGUID = 'B974CFB4-AE27-4A72-A1D7-927B84C5CB62') --Manage Users
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'Manage Users'

SET @PageId  = (SELECT PageId FROM [System].[Page] WHERE PageGUID = '80B1CC99-7C91-4D07-A541-9D69AC4CC304') --Manage Customers
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'Manage Customers'

SET @PageId  = (SELECT PageId FROM [System].[Page] WHERE PageGUID = '33A6D63F-D9C7-45FA-9BCF-B471F1A3D842') --My Documents
EXEC [System].[PageDetail_Insert] @CreatedByUserId, @SourceId, @PageId, @PageAttributeId, 'My Documents'