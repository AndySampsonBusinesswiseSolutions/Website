...
EXEC [Customer].[DataUploadValidationErrorAttribute_Insert] @CreatedByUserId, @SourceId, 'Sheet Name'
EXEC [Customer].[DataUploadValidationErrorAttribute_Insert] @CreatedByUserId, @SourceId, 'Row Number'
