...
GO
ALTER TABLE [Communication].[CommunicationType] ADD CONSTRAINT
	DF_CommunicationType_EffectiveFromDateTime DEFAULT GETUTCDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [Communication].[CommunicationType] ADD CONSTRAINT
	DF_CommunicationType_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [Communication].[CommunicationType] ADD CONSTRAINT
	DF_CommunicationType_CreatedDateTime DEFAULT GETUTCDATE() FOR CreatedDateTime
GO
ALTER TABLE [Communication].[CommunicationType] ADD CONSTRAINT
