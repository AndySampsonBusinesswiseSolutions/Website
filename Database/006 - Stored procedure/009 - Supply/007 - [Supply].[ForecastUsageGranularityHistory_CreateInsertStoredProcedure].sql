...
BEGIN
    ...
    BEGIN
        ...
        IF NOT EXISTS(SELECT TOP 1 1 FROM [' + @SchemaName +'].[ForecastUsage' + @GranularityCode + 'History] WHERE TimePeriodId = @TimePeriodId'
    ...
    SET @SQL = @SQL + ')
        BEGIN
            INSERT INTO [' + @SchemaName +'].[ForecastUsage' + @GranularityCode + 'History]
            (
                CreatedByUserId,
                SourceId,
                TimePeriodId,'
