...
BEGIN
    ...
    DECLARE @StoredProcedureName NVARCHAR(255) = 'ForecastUsage' + @GranularityCode + 'Latest_Insert'
    ...
    -- Description:	Insert usage into [' + @SchemaName +'].[ForecastUsage' + @GranularityCode + 'Latest] table
    -- =============================================
