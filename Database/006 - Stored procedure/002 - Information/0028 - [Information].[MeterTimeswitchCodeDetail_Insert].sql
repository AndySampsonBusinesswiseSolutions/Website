...
BEGIN
    ...
    IF NOT EXISTS(SELECT TOP 1 1 FROM [Information].[MeterTimeswitchCodeDetail] WHERE MeterTimeswitchCodeId = @MeterTimeswitchCodeId 
        AND MeterTimeswitchCodeAttributeId = @MeterTimeswitchCodeAttributeId 
