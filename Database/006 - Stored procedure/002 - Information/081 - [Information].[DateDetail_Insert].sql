...
BEGIN
    ...
    IF NOT EXISTS(SELECT TOP 1 1 FROM [Information].[DateDetail] WHERE DateId = @DateId 
        AND DateAttributeId = @DateAttributeId 
        AND DateDetailDescription = @DateDetailDescription
