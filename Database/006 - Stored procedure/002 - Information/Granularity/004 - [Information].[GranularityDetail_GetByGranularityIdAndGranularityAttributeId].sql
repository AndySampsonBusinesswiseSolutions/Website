...
IF NOT EXISTS(SELECT TOP 1 1 FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('[Information].[GranularityDetail_GetByGranularityIdAndGranularityAttributeId]'))
    BEGIN
        EXEC('CREATE PROCEDURE [Information].[GranularityDetail_GetByGranularityIdAndGranularityAttributeId] AS BEGIN SET NOCOUNT ON; END')
    END
GO
...
ALTER PROCEDURE [Information].[GranularityDetail_GetByGranularityIdAndGranularityAttributeId]
