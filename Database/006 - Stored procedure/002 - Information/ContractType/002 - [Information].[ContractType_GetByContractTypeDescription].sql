...
IF NOT EXISTS(SELECT TOP 1 1 FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('[Information].[ContractType_GetByContractTypeDescription]'))
    BEGIN
        EXEC('CREATE PROCEDURE [Information].[ContractType_GetByContractTypeDescription] AS BEGIN SET NOCOUNT ON; END')
    END
GO
