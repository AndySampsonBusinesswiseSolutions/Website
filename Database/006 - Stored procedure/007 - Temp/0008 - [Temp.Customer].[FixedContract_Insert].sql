...
IF NOT EXISTS(SELECT TOP 1 1 FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('[Temp.Customer].[FixedContract_Insert]'))
    BEGIN
        EXEC('CREATE PROCEDURE [Temp.Customer].[FixedContract_Insert] AS BEGIN SET NOCOUNT ON; END')
    END
GO
...
-- Description:	Insert new FixedContract into [Temp.Customer].[FixedContract] table
-- =============================================
