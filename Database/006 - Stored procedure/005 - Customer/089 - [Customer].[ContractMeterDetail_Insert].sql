...
BEGIN
    ...
    IF NOT EXISTS(SELECT TOP 1 1 FROM [Customer].[ContractMeterDetail] WHERE ContractMeterId = @ContractMeterId 
        AND ContractMeterAttributeId = @ContractMeterAttributeId 
