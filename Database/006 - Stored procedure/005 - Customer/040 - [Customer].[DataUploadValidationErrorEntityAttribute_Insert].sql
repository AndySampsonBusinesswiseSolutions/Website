...
BEGIN
    ...
    IF NOT EXISTS(SELECT TOP 1 1 FROM [Customer].[DataUploadValidationErrorEntityAttribute] WHERE DataUploadValidationErrorEntityAttributeDescription = @DataUploadValidationErrorEntityAttributeDescription
