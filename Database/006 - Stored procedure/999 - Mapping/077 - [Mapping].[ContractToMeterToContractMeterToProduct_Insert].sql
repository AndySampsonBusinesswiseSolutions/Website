...
BEGIN
    ...
    IF NOT EXISTS(SELECT TOP 1 1 FROM [Mapping].[ContractToMeterToContractMeterToProduct] WHERE ContractToMeterId = @ContractToMeterId AND ContractMeterToProductId = @ContractMeterToProductId
