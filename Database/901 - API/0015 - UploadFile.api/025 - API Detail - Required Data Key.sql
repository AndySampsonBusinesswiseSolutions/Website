...
DECLARE @APIId BIGINT = (SELECT APIId FROM [System].[API] WHERE APIGUID = '5681C395-98AC-4410-98DE-DBB550106EF2')
...
EXEC [System].[APIDetail_Insert] @CreatedByUserId, @SourceId, @APIId, @APIAttributeId, 'FileContent'
EXEC [System].[APIDetail_Insert] @CreatedByUserId, @SourceId, @APIId, @APIAttributeId, 'FileName'
