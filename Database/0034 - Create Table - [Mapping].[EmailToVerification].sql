...
GO
ALTER TABLE [Mapping].[EmailToVerification] ADD CONSTRAINT
	DF_EmailToVerification_EffectiveFromDateTime DEFAULT GETDATE() FOR EffectiveFromDateTime
GO
ALTER TABLE [Mapping].[EmailToVerification] ADD CONSTRAINT
	DF_EmailToVerification_EffectiveToDateTime DEFAULT '9999-12-31' FOR EffectiveToDateTime
GO
ALTER TABLE [Mapping].[EmailToVerification] ADD CONSTRAINT
	DF_EmailToVerification_CreatedDateTime DEFAULT GETDATE() FOR CreatedDateTime
GO
ALTER TABLE [Mapping].[EmailToVerification] ADD CONSTRAINT
