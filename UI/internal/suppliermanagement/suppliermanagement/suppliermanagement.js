	...
	if(checkbox.checked){
		if(!button) {
			...
			if(!span.innerText.includes('Add New ')) {
				button.innerHTML += '<i class="fas fa-cart-arrow-down show-pointer" style="float: right;" title="Add Supplier To Download Basket"></i>'
				+ '<i class="fas fa-download show-pointer" style="margin-right: 5px; float: right;" title="Download Supplier"></i>';
			}
