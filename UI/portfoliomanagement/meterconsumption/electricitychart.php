	...
	<div>
		<div class="group-div">
			<div class="group-by-div">
				...
				<span class="chart-header">Need Graph Title Here</span>
				...
				<span>Period:</span>
				<span class="show-pointer">
					<span class="arrow-header" title="Period" style="padding-left: 10px;" id="electricityChartHeaderPeriod">Monthly</span>
